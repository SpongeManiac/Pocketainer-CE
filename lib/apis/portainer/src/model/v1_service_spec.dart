...
/// * [externalName] - externalName is the external reference that discovery mechanisms will return as an alias for this service (e.g. a DNS CNAME record). No proxying will be involved.  Must be a lowercase RFC-1123 hostname (https://tools.ietf.org/html/rfc1123) and requires `type` to be \"ExternalName\". +optional
...
/// * [ports] - The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies +patchMergeKey=port +patchStrategy=merge +listType=map +listMapKey=port +listMapKey=protocol
...
/// * [sessionAffinity] - Supports \"ClientIP\" and \"None\". Used to maintain session affinity. Enable client IP based session affinity. Must be ClientIP or None. Defaults to None. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies +optional
...
@BuiltValue()
abstract class V1ServiceSpec implements Built<V1ServiceSpec, V1ServiceSpecBuilder> {
  ...
  BuiltList<V1ServicePort>? get ports;
  ...
  V1SessionAffinityConfig? get sessionAffinityConfig;
  ...
  factory V1ServiceSpec([void updates(V1ServiceSpecBuilder b)]) = _$V1ServiceSpec;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1ServiceSpecBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1ServiceSpec> get serializer => _$V1ServiceSpecSerializer();
}

class _$V1ServiceSpecSerializer implements PrimitiveSerializer<V1ServiceSpec> {
  @override
  final Iterable<Type> types = const [V1ServiceSpec, _$V1ServiceSpec];

  @override
  final String wireName = r'V1ServiceSpec';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V1ServiceSpec object, {
    ...
    if (object.ports != null) {
      ...
      yield serializers.serialize(
        object.ports,
        specifiedType: const FullType(BuiltList, [FullType(V1ServicePort)]),
      );
    }
    ...
    if (object.sessionAffinityConfig != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(V1SessionAffinityConfig),
      );
    }
    if (object.type != null) {
      yield r'type';
  ...
  void _deserializeProperties(
    ...
    required V1ServiceSpecBuilder result,
  ...
  @override
  V1ServiceSpec deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V1ServiceSpecBuilder();
