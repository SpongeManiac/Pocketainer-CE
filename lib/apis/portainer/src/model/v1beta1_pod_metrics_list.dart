...
part 'v1beta1_pod_metrics_list.g.dart';
...
@BuiltValue()
abstract class V1beta1PodMetricsList implements Built<V1beta1PodMetricsList, V1beta1PodMetricsListBuilder> {
  ...
  BuiltList<V1beta1PodMetrics>? get items;
  ...
  V1beta1PodMetricsList._();

  factory V1beta1PodMetricsList([void updates(V1beta1PodMetricsListBuilder b)]) = _$V1beta1PodMetricsList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1beta1PodMetricsListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1beta1PodMetricsList> get serializer => _$V1beta1PodMetricsListSerializer();
}

class _$V1beta1PodMetricsListSerializer implements PrimitiveSerializer<V1beta1PodMetricsList> {
  @override
  final Iterable<Type> types = const [V1beta1PodMetricsList, _$V1beta1PodMetricsList];

  @override
  final String wireName = r'V1beta1PodMetricsList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V1beta1PodMetricsList object, {
    ...
    if (object.items != null) {
      ...
      yield serializers.serialize(
        object.items,
        specifiedType: const FullType(BuiltList, [FullType(V1beta1PodMetrics)]),
      );
    }
    if (object.kind != null) {
      yield r'kind';
  ...
  void _deserializeProperties(
    ...
    required V1beta1PodMetricsListBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(V1beta1PodMetrics)]),
          ) as BuiltList<V1beta1PodMetrics>;
  ...
  @override
  V1beta1PodMetricsList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V1beta1PodMetricsListBuilder();
