...
part 'stacks_compose_stack_from_git_repository_payload.g.dart';
...
@BuiltValue()
abstract class StacksComposeStackFromGitRepositoryPayload
    implements Built<StacksComposeStackFromGitRepositoryPayload, StacksComposeStackFromGitRepositoryPayloadBuilder> {
  ...
  StacksComposeStackFromGitRepositoryPayload._();

  factory StacksComposeStackFromGitRepositoryPayload(
          [void updates(StacksComposeStackFromGitRepositoryPayloadBuilder b)]) =
      _$StacksComposeStackFromGitRepositoryPayload;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StacksComposeStackFromGitRepositoryPayloadBuilder b) => b..composeFile = 'docker-compose.yml';

  @BuiltValueSerializer(custom: true)
  static Serializer<StacksComposeStackFromGitRepositoryPayload> get serializer =>
      _$StacksComposeStackFromGitRepositoryPayloadSerializer();
}

class _$StacksComposeStackFromGitRepositoryPayloadSerializer
    implements PrimitiveSerializer<StacksComposeStackFromGitRepositoryPayload> {
  @override
  ...
  @override
  final String wireName = r'StacksComposeStackFromGitRepositoryPayload';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    StacksComposeStackFromGitRepositoryPayload object, {
  ...
  void _deserializeProperties(
    ...
    required StacksComposeStackFromGitRepositoryPayloadBuilder result,
  ...
  @override
  StacksComposeStackFromGitRepositoryPayload deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StacksComposeStackFromGitRepositoryPayloadBuilder();
