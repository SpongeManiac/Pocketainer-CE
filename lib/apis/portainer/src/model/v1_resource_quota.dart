...
@BuiltValue()
abstract class V1ResourceQuota implements Built<V1ResourceQuota, V1ResourceQuotaBuilder> {
  ...
  V1ResourceQuotaSpec? get spec;

  @BuiltValueField(wireName: r'status')
  V1ResourceQuotaStatus? get status;
  ...
  factory V1ResourceQuota([void updates(V1ResourceQuotaBuilder b)]) = _$V1ResourceQuota;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1ResourceQuotaBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1ResourceQuota> get serializer => _$V1ResourceQuotaSerializer();
}

class _$V1ResourceQuotaSerializer implements PrimitiveSerializer<V1ResourceQuota> {
  @override
  final Iterable<Type> types = const [V1ResourceQuota, _$V1ResourceQuota];

  @override
  final String wireName = r'V1ResourceQuota';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V1ResourceQuota object, {
    ...
    if (object.spec != null) {
      ...
      yield serializers.serialize(
        object.spec,
        specifiedType: const FullType(V1ResourceQuotaSpec),
      );
    }
    if (object.status != null) {
      ...
      yield serializers.serialize(
        object.status,
        specifiedType: const FullType(V1ResourceQuotaStatus),
      );
    }
    if (object.uid != null) {
      yield r'uid';
  ...
  void _deserializeProperties(
    ...
    required V1ResourceQuotaBuilder result,
  ...
  @override
  V1ResourceQuota deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V1ResourceQuotaBuilder();
