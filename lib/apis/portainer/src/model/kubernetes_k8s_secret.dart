...
part 'kubernetes_k8s_secret.g.dart';
...
/// * [UID]
@BuiltValue()
abstract class KubernetesK8sSecret implements Built<KubernetesK8sSecret, KubernetesK8sSecretBuilder> {
  ...
  @BuiltValueField(wireName: r'SecretType')
  String? get secretType;

  @BuiltValueField(wireName: r'UID')
  String? get UID;

  KubernetesK8sSecret._();

  factory KubernetesK8sSecret([void updates(KubernetesK8sSecretBuilder b)]) = _$KubernetesK8sSecret;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(KubernetesK8sSecretBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<KubernetesK8sSecret> get serializer => _$KubernetesK8sSecretSerializer();
}

class _$KubernetesK8sSecretSerializer implements PrimitiveSerializer<KubernetesK8sSecret> {
  @override
  final Iterable<Type> types = const [KubernetesK8sSecret, _$KubernetesK8sSecret];

  @override
  final String wireName = r'KubernetesK8sSecret';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    KubernetesK8sSecret object, {
  ...
  void _deserializeProperties(
    ...
    required KubernetesK8sSecretBuilder result,
  ...
  @override
  KubernetesK8sSecret deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = KubernetesK8sSecretBuilder();
