...
part 'v1beta1_pod_metrics.g.dart';
...
/// * [window]
@BuiltValue()
abstract class V1beta1PodMetrics implements Built<V1beta1PodMetrics, V1beta1PodMetricsBuilder> {
  ...
  BuiltList<V1beta1ContainerMetrics>? get containers;
  ...
  V1Duration? get window;

  V1beta1PodMetrics._();

  factory V1beta1PodMetrics([void updates(V1beta1PodMetricsBuilder b)]) = _$V1beta1PodMetrics;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1beta1PodMetricsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1beta1PodMetrics> get serializer => _$V1beta1PodMetricsSerializer();
}

class _$V1beta1PodMetricsSerializer implements PrimitiveSerializer<V1beta1PodMetrics> {
  @override
  final Iterable<Type> types = const [V1beta1PodMetrics, _$V1beta1PodMetrics];

  @override
  final String wireName = r'V1beta1PodMetrics';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V1beta1PodMetrics object, {
    ...
    if (object.containers != null) {
      ...
      yield serializers.serialize(
        object.containers,
        specifiedType: const FullType(BuiltList, [FullType(V1beta1ContainerMetrics)]),
      );
    }
    ...
    if (object.window != null) {
      ...
      yield serializers.serialize(
        object.window,
        specifiedType: const FullType(V1Duration),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required V1beta1PodMetricsBuilder result,
      ...
      switch (key) {
        ...
        case r'containers':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(V1beta1ContainerMetrics)]),
          ) as BuiltList<V1beta1ContainerMetrics>;
  ...
  @override
  V1beta1PodMetrics deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V1beta1PodMetricsBuilder();
