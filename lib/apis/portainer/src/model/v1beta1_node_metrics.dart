...
part 'v1beta1_node_metrics.g.dart';
...
/// * [window]
@BuiltValue()
abstract class V1beta1NodeMetrics implements Built<V1beta1NodeMetrics, V1beta1NodeMetricsBuilder> {
  ...
  V1beta1NodeMetrics._();

  factory V1beta1NodeMetrics([void updates(V1beta1NodeMetricsBuilder b)]) = _$V1beta1NodeMetrics;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1beta1NodeMetricsBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1beta1NodeMetrics> get serializer => _$V1beta1NodeMetricsSerializer();
}

class _$V1beta1NodeMetricsSerializer implements PrimitiveSerializer<V1beta1NodeMetrics> {
  @override
  final Iterable<Type> types = const [V1beta1NodeMetrics, _$V1beta1NodeMetrics];

  @override
  final String wireName = r'V1beta1NodeMetrics';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V1beta1NodeMetrics object, {
  ...
  void _deserializeProperties(
    ...
    required V1beta1NodeMetricsBuilder result,
  ...
  @override
  V1beta1NodeMetrics deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V1beta1NodeMetricsBuilder();
