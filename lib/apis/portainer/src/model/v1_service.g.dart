...
class _$V1Service extends V1Service {
  @override
  ...
  factory _$V1Service([void Function(V1ServiceBuilder)? updates]) =>
      (new V1ServiceBuilder()..update(updates))._build();
  ...
  @override
  V1Service rebuild(void Function(V1ServiceBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  V1ServiceBuilder toBuilder() => new V1ServiceBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is V1Service &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'V1Service')
...
class V1ServiceBuilder implements Builder<V1Service, V1ServiceBuilder> {
  _$V1Service? _$v;
  ...
  V1ServiceSpecBuilder? _spec;
  V1ServiceSpecBuilder get spec => _$this._spec ??= new V1ServiceSpecBuilder();
  set spec(V1ServiceSpecBuilder? spec) => _$this._spec = spec;

  V1ServiceStatusBuilder? _status;
  V1ServiceStatusBuilder get status =>
      _$this._status ??= new V1ServiceStatusBuilder();
  set status(V1ServiceStatusBuilder? status) => _$this._status = status;
  ...
  V1ServiceBuilder() {
    V1Service._defaults(this);
  }

  V1ServiceBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(V1Service other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$V1Service;
  }

  @override
  void update(void Function(V1ServiceBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  V1Service build() => _build();

  _$V1Service _build() {
    _$V1Service _$result;
    try {
      _$result = _$v ??
          new _$V1Service._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'V1Service', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
