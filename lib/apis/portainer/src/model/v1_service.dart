...
@BuiltValue()
abstract class V1Service implements Built<V1Service, V1ServiceBuilder> {
  ...
  V1ServiceSpec? get spec;

  @BuiltValueField(wireName: r'status')
  V1ServiceStatus? get status;
  ...
  factory V1Service([void updates(V1ServiceBuilder b)]) = _$V1Service;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V1ServiceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V1Service> get serializer => _$V1ServiceSerializer();
}

class _$V1ServiceSerializer implements PrimitiveSerializer<V1Service> {
  @override
  final Iterable<Type> types = const [V1Service, _$V1Service];

  @override
  final String wireName = r'V1Service';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.spec != null) {
      ...
      yield serializers.serialize(
        object.spec,
        specifiedType: const FullType(V1ServiceSpec),
      );
    }
    if (object.status != null) {
      ...
      yield serializers.serialize(
        object.status,
        specifiedType: const FullType(V1ServiceStatus),
      );
    }
    if (object.uid != null) {
      yield r'uid';
  ...
  void _deserializeProperties(
    ...
    required V1ServiceBuilder result,
  ...
  @override
  V1Service deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V1ServiceBuilder();
