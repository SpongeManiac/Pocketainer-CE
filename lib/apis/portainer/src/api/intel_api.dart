...
class IntelApi {
  ...
  const IntelApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deviceAction({
    required int id,
    required int deviceId,
    required OpenamtDeviceActionPayload body,
    ...
    final _path = r'/open_amt/{id}/devices/{deviceId}/action'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString())
        .replaceAll('{' r'deviceId' '}', encodeQueryParameter(_serializers, deviceId, const FullType(int)).toString());
    ...
    try {
      const _type = FullType(OpenamtDeviceActionPayload);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deviceFeatures({
    required int id,
    required int deviceId,
    required OpenamtDeviceFeaturesPayload body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/open_amt/{id}/devices_features/{deviceId}'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString())
        .replaceAll('{' r'deviceId' '}', encodeQueryParameter(_serializers, deviceId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
    ...
    try {
      const _type = FullType(OpenamtDeviceFeaturesPayload);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> openAMTActivate({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/open_amt/{id}/activate'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> openAMTConfigure({
    required OpenamtOpenAMTConfigurePayload body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(OpenamtOpenAMTConfigurePayload);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> openAMTDevices({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/open_amt/{id}/devices'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> openAMTHostInfo({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/open_amt/{id}/info'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
