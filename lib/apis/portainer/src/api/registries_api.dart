...
class RegistriesApi {
  ...
  const RegistriesApi(this._dio, this._serializers);
  ...
  Future<Response<void>> registryConfigure({
    required int id,
    required RegistriesRegistryConfigurePayload body,
    ...
    final _path = r'/registries/{id}/configure'
    ...
    try {
      const _type = FullType(RegistriesRegistryConfigurePayload);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PortainerRegistry] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PortainerRegistry>> registryCreate({
    required RegistriesRegistryCreatePayload body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RegistriesRegistryCreatePayload);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    PortainerRegistry? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PortainerRegistry),
            ) as PortainerRegistry;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<PortainerRegistry>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> registryDelete({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [PortainerRegistry] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PortainerRegistry>> registryInspect({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<PortainerRegistry>>> registryList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [PortainerRegistry] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PortainerRegistry>> registryUpdate({
    required int id,
    required RegistriesRegistryUpdatePayload body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RegistriesRegistryUpdatePayload);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
