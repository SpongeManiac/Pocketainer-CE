...
class EndpointGroupsApi {
  ...
  const EndpointGroupsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> endpointGroupAddEndpoint({
    required int id,
    ...
    final _path = r'/endpoint_groups/{id}/endpoints/{endpointId}'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString())
        .replaceAll(
            '{' r'endpointId' '}', encodeQueryParameter(_serializers, endpointId, const FullType(int)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> endpointGroupDelete({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/endpoint_groups/{id}'
        .replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> endpointGroupDeleteEndpoint({
    required int id,
    required int endpointId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<PortainerEndpointGroup>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<PortainerEndpointGroup>>> endpointGroupList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<PortainerEndpointGroup>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(PortainerEndpointGroup)]),
            ) as BuiltList<PortainerEndpointGroup>;
    ...
    return Response<BuiltList<PortainerEndpointGroup>>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PortainerEndpointGroup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PortainerEndpointGroup>> endpointGroupUpdate({
    required int id,
    required EndpointgroupsEndpointGroupUpdatePayload body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EndpointgroupsEndpointGroupUpdatePayload);
    ...
    PortainerEndpointGroup? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PortainerEndpointGroup),
            ) as PortainerEndpointGroup;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<PortainerEndpointGroup>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [PortainerEndpointGroup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PortainerEndpointGroup>> endpointGroupsIdGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  ///
  /// Parameters:
  /// * [body] - Environment(Endpoint) Group details
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [PortainerEndpointGroup] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PortainerEndpointGroup>> endpointGroupsPost({
    required EndpointgroupsEndpointGroupCreatePayload body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EndpointgroupsEndpointGroupCreatePayload);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
