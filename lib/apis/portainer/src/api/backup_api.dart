...
class BackupApi {
  ...
  ///
  /// Parameters:
  /// * [body] - An object contains the password to encrypt the backup with
  ...
  Future<Response<void>> backup({
    BackupBackupPayload? body,
    ...
    try {
      const _type = FullType(BackupBackupPayload);
  ...
  ///
  /// Parameters:
  /// * [restorePayload] - Restore request payload
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> restore({
    required BackupRestorePayload restorePayload,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BackupRestorePayload);
      _bodyData = _serializers.serialize(restorePayload, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
