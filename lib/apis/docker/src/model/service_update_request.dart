...
part 'service_update_request.g.dart';
...
/// * [endpointSpec]
@BuiltValue()
abstract class ServiceUpdateRequest implements ServiceSpec, Built<ServiceUpdateRequest, ServiceUpdateRequestBuilder> {
  ServiceUpdateRequest._();

  factory ServiceUpdateRequest([void updates(ServiceUpdateRequestBuilder b)]) = _$ServiceUpdateRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ServiceUpdateRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ServiceUpdateRequest> get serializer => _$ServiceUpdateRequestSerializer();
}

class _$ServiceUpdateRequestSerializer implements PrimitiveSerializer<ServiceUpdateRequest> {
  @override
  final Iterable<Type> types = const [ServiceUpdateRequest, _$ServiceUpdateRequest];

  @override
  final String wireName = r'ServiceUpdateRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ServiceUpdateRequest object, {
  ...
  void _deserializeProperties(
    ...
    required ServiceUpdateRequestBuilder result,
  ...
  @override
  ServiceUpdateRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ServiceUpdateRequestBuilder();
