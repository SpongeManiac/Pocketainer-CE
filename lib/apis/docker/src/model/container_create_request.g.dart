...
part of 'container_create_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ContainerCreateRequest extends ContainerCreateRequest {
  @override
  ...
  factory _$ContainerCreateRequest(
          [void Function(ContainerCreateRequestBuilder)? updates]) =>
      (new ContainerCreateRequestBuilder()..update(updates))._build();

  _$ContainerCreateRequest._(
  ...
  @override
  ContainerCreateRequest rebuild(
          void Function(ContainerCreateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ContainerCreateRequestBuilder toBuilder() =>
      new ContainerCreateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ContainerCreateRequest &&
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, networkingConfig.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ContainerCreateRequest')
          ..add('networkingConfig', networkingConfig)
...
class ContainerCreateRequestBuilder
    implements
        Builder<ContainerCreateRequest, ContainerCreateRequestBuilder>,
        ContainerConfigBuilder {
  _$ContainerCreateRequest? _$v;

  NetworkingConfigBuilder? _networkingConfig;
  NetworkingConfigBuilder get networkingConfig =>
      _$this._networkingConfig ??= new NetworkingConfigBuilder();
  set networkingConfig(covariant NetworkingConfigBuilder? networkingConfig) =>
      _$this._networkingConfig = networkingConfig;

  HostConfigBuilder? _hostConfig;
  HostConfigBuilder get hostConfig =>
      _$this._hostConfig ??= new HostConfigBuilder();
  set hostConfig(covariant HostConfigBuilder? hostConfig) =>
  ...
  ContainerCreateRequestBuilder() {
    ContainerCreateRequest._defaults(this);
  }

  ContainerCreateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _networkingConfig = $v.networkingConfig?.toBuilder();
  ...
  @override
  void replace(covariant ContainerCreateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ContainerCreateRequest;
  }

  @override
  void update(void Function(ContainerCreateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ContainerCreateRequest build() => _build();

  _$ContainerCreateRequest _build() {
    _$ContainerCreateRequest _$result;
    try {
      _$result = _$v ??
          new _$ContainerCreateRequest._(
            networkingConfig: _networkingConfig?.build(),
      ...
      try {
        _$failedField = 'networkingConfig';
        _networkingConfig?.build();
        ...
        throw new BuiltValueNestedFieldError(
            r'ContainerCreateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
