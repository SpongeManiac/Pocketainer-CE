...
class _$ImageConfig extends ImageConfig {
  @override
  ...
  factory _$ImageConfig([void Function(ImageConfigBuilder)? updates]) =>
      (new ImageConfigBuilder()..update(updates))._build();
  ...
  @override
  ImageConfig rebuild(void Function(ImageConfigBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ImageConfigBuilder toBuilder() => new ImageConfigBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ImageConfig')
...
class ImageConfigBuilder implements Builder<ImageConfig, ImageConfigBuilder> {
  _$ImageConfig? _$v;
  ...
  set stdinOnce(bool? stdinOnce) => _$this._stdinOnce = stdinOnce;
  ...
  set argsEscaped(bool? argsEscaped) => _$this._argsEscaped = argsEscaped;
  ...
  set onBuild(ListBuilder<String>? onBuild) => _$this._onBuild = onBuild;
  ...
  set stopTimeout(int? stopTimeout) => _$this._stopTimeout = stopTimeout;

  ListBuilder<String>? _shell;
  ListBuilder<String> get shell => _$this._shell ??= new ListBuilder<String>();
  set shell(ListBuilder<String>? shell) => _$this._shell = shell;

  ImageConfigBuilder() {
    ImageConfig._defaults(this);
  }

  ImageConfigBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ImageConfig other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ImageConfig;
  }

  @override
  void update(void Function(ImageConfigBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ImageConfig build() => _build();

  _$ImageConfig _build() {
    _$ImageConfig _$result;
    try {
      _$result = _$v ??
          new _$ImageConfig._(
            hostname: hostname,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ImageConfig', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
