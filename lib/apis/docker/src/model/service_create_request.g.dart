...
part of 'service_create_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ServiceCreateRequest extends ServiceCreateRequest {
  @override
  final String? name;
  @override
  ...
  factory _$ServiceCreateRequest(
          [void Function(ServiceCreateRequestBuilder)? updates]) =>
      (new ServiceCreateRequestBuilder()..update(updates))._build();

  _$ServiceCreateRequest._(
      {this.name,
      this.labels,
      this.taskTemplate,
      this.mode,
  ...
  @override
  ServiceCreateRequest rebuild(
          void Function(ServiceCreateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ServiceCreateRequestBuilder toBuilder() =>
      new ServiceCreateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ServiceCreateRequest &&
        name == other.name &&
        labels == other.labels &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceCreateRequest')
          ..add('name', name)
          ..add('labels', labels)
...
class ServiceCreateRequestBuilder
    implements
        Builder<ServiceCreateRequest, ServiceCreateRequestBuilder>,
        ServiceSpecBuilder {
  _$ServiceCreateRequest? _$v;
  ...
  ServiceCreateRequestBuilder() {
    ServiceCreateRequest._defaults(this);
  }

  ServiceCreateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant ServiceCreateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ServiceCreateRequest;
  }

  @override
  void update(void Function(ServiceCreateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ServiceCreateRequest build() => _build();

  _$ServiceCreateRequest _build() {
    _$ServiceCreateRequest _$result;
    try {
      _$result = _$v ??
          new _$ServiceCreateRequest._(
            name: name,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ServiceCreateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
