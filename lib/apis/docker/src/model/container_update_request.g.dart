...
part of 'container_update_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ContainerUpdateRequest extends ContainerUpdateRequest {
  @override
  ...
  factory _$ContainerUpdateRequest(
          [void Function(ContainerUpdateRequestBuilder)? updates]) =>
      (new ContainerUpdateRequestBuilder()..update(updates))._build();

  _$ContainerUpdateRequest._(
      {this.restartPolicy,
      this.cpuShares,
      this.memory,
      this.cgroupParent,
  ...
  @override
  ContainerUpdateRequest rebuild(
          void Function(ContainerUpdateRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ContainerUpdateRequestBuilder toBuilder() =>
      new ContainerUpdateRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ContainerUpdateRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ContainerUpdateRequest')
...
class ContainerUpdateRequestBuilder
    implements
        Builder<ContainerUpdateRequest, ContainerUpdateRequestBuilder>,
        ResourcesBuilder {
  _$ContainerUpdateRequest? _$v;
  ...
  ContainerUpdateRequestBuilder() {
    ContainerUpdateRequest._defaults(this);
  }

  ContainerUpdateRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(covariant ContainerUpdateRequest other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ContainerUpdateRequest;
  }

  @override
  void update(void Function(ContainerUpdateRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ContainerUpdateRequest build() => _build();

  _$ContainerUpdateRequest _build() {
    _$ContainerUpdateRequest _$result;
    try {
      _$result = _$v ??
          new _$ContainerUpdateRequest._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ContainerUpdateRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
