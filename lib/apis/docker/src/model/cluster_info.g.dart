...
abstract mixin class ClusterInfoBuilder {
  ...
  set version(ObjectVersionBuilder? version);
  ...
  SwarmSpecBuilder get spec;
  set spec(SwarmSpecBuilder? spec);

  TLSInfoBuilder get tLSInfo;
  set tLSInfo(TLSInfoBuilder? tLSInfo);

  bool? get rootRotationInProgress;
  set rootRotationInProgress(bool? rootRotationInProgress);

  int? get dataPathPort;
  set dataPathPort(int? dataPathPort);

  ListBuilder<String> get defaultAddrPool;
  set defaultAddrPool(ListBuilder<String>? defaultAddrPool);

  int? get subnetSize;
  set subnetSize(int? subnetSize);
}
...
class _$$ClusterInfo extends $ClusterInfo {
  ...
  factory _$$ClusterInfo([void Function($ClusterInfoBuilder)? updates]) =>
      (new $ClusterInfoBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$ClusterInfo')
          ..add('ID', ID)
          ..add('version', version)
...
class $ClusterInfoBuilder
    implements Builder<$ClusterInfo, $ClusterInfoBuilder>, ClusterInfoBuilder {
  _$$ClusterInfo? _$v;
  ...
  @override
  void replace(covariant $ClusterInfo other) {
  ...
  @override
  $ClusterInfo build() => _build();

  _$$ClusterInfo _build() {
    _$$ClusterInfo _$result;
    try {
      _$result = _$v ??
          new _$$ClusterInfo._(
            ID: ID,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$ClusterInfo', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
